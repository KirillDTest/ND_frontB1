// http://www.codeabbey.com/index/task_view/bicycle-race--ru

/////////////////////////////////////////////////////////////////////////////////////////////////
//////////////////////FIRST VARIANT (не правильно (Кирилл)//////////////////////////////////////
// Первый вариант отпадает. Будет работать только тогда, когда велосипедисты встречаются на
// расстоянии, которое будет целым числом. Не совсем тот подход, просто из-за того,
// что в цикле мы делаем шаг в единицу. Если бы делали, к примеру, шаг в
// 0.01, а не 1, то он бы сработал, другой вопрос, что это долго)
/////////////////////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////////////////
//////////////////////SECOND VARIANT///////////////////////////////////////////////////////
//           тут реализован шаг в метрах в секунду
//////////////////////////////////////////////////////////////////////////////////////////
var meetingPoint = function (S,v1,v2) {
	var s1=0;
	var s2=0;
...
//////////////////////////////////////////////////////////////////////////////////////////
//////////////////////FOURTH VARIANT (KIRIL)//////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////
//Lesson26   5:50-18:20
var race = function (distance, speed1, speed2) {
	var speed = speed1+speed2;
	var distanceFromCity1 = distance/speed;
	if (speed1>speed2) {
		return distance-distanceFromCity1;
	}
	else return distanceFromCity1;
}
console.log("Fourth variant (Kiril)");
console.log(meetingPoint(10,1,1));
console.log(meetingPoint(20,1,2));
